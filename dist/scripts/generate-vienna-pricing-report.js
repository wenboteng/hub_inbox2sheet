...
exports.generateViennaPricingReport = generateViennaPricingReport;
...
async function generateViennaPricingReport() {
    ...
    try {
        ...
        const activityTypePricing = new Map();
        ...
        viennaActivities.forEach(activity => {
            if (activity.venue) {
                ...
                if (activity.ratingNumeric)
                    venueData.avgRating += activity.ratingNumeric;
        ...
        viennaActivities.forEach(activity => {
            ...
            if (activity.ratingNumeric)
                durationData.avgRating += activity.ratingNumeric;
...
//# sourceMappingURL=generate-vienna-pricing-report.js.map