                ...
                for (const activity of batch) {
                    try {
                        if (activity.id && activity.activity_name) {
                            ...
                            const existingActivity = await dual_prisma_1.mainPrisma.importedGYGActivity.findUnique({
...
`;
        ...
        await dual_prisma_1.mainPrisma.report.upsert({
            ...
            create: {
                ...
                slug: (0, slugify_1.slugify)('Madrid Activities Import Report'),
                content: report,
                isPublic: false,
            },
            update: {
...
//# sourceMappingURL=import-madrid-activities.js.map