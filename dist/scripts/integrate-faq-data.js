...
exports.integrateExistingData = integrateExistingData;
exports.transformArticleToFAQ = transformArticleToFAQ;
...
function determineDifficulty(content) {
    ...
    if (hasTechnicalTerms && hasComplexConcepts)
        return 'advanced';
    if (hasTechnicalTerms || hasComplexConcepts)
        return 'intermediate';
    return 'beginner';
...
async function transformArticleToFAQ(article) {
    ...
    return {
        ...
        categoryId: FAQ_CATEGORIES[category]?.id || 'general',
...
async function integrateExistingData() {
...
//# sourceMappingURL=integrate-faq-data.js.map