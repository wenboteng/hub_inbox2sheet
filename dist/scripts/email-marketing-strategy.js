...
exports.generateEmailMarketingStrategy = generateEmailMarketingStrategy;
...
`;
    (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), 'email-marketing-strategy.md'), strategyContent);
...
${campaign.content}`;
        (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), `email-template-${index + 1}.html`), templateContent);
    });
...
//# sourceMappingURL=email-marketing-strategy.js.map