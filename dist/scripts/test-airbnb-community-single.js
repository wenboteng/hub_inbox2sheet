...
async function testSingleThread() {
    ...
    try {
        ...
        if (title.text && content.text) {
            ...
            const cleanedContent = (0, parseHelpers_1.cleanText)(content.text);
            const language = await (0, languageDetection_1.detectLanguage)(cleanedContent);
...
//# sourceMappingURL=test-airbnb-community-single.js.map