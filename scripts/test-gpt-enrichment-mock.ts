...
function mockEnrichReportTitleAndIntro(title: string, intro: string): { enrichedTitle: string; enrichedIntro: string } {
...
function mockGenerateSummaryBoxes(reportContent: string): string[] {
...
function mockGenerateShareSuggestions(reportContent: string): string[] {
  return [
...
function mockEnrichReportWithGPT(reportContent: string, originalTitle?: string): EnrichmentResult {
