...
exports.generateTrafficImplementationPlan = generateTrafficImplementationPlan;
...
async function generateTrafficImplementationPlan() {
    ...
    try {
        ...
        (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), 'traffic-implementation-plan.json'), JSON.stringify(implementationPlan, null, 2));
...
//# sourceMappingURL=traffic-generation-implementation.js.map