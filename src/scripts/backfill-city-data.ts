...
function extractCityFromLocation(location: string | null, region: string | null): string {
  ...
  // European cities
  if (locationLower.includes('vienna')) return 'Vienna';
  if (locationLower.includes('amsterdam')) return 'Amsterdam';
  if (locationLower.includes('madrid')) return 'Madrid';
  if (locationLower.includes('rome')) return 'Rome';
  if (locationLower.includes('barcelona')) return 'Barcelona';
  if (locationLower.includes('paris')) return 'Paris';
  if (locationLower.includes('berlin')) return 'Berlin';
  if (locationLower.includes('milan')) return 'Milan';
  if (locationLower.includes('florence')) return 'Florence';
  if (locationLower.includes('venice')) return 'Venice';
  if (locationLower.includes('prague')) return 'Prague';
  if (locationLower.includes('budapest')) return 'Budapest';
  if (locationLower.includes('lisbon')) return 'Lisbon';
  if (locationLower.includes('porto')) return 'Porto';
  if (locationLower.includes('seville')) return 'Seville';
  if (locationLower.includes('granada')) return 'Granada';
  if (locationLower.includes('valencia')) return 'Valencia';
  if (locationLower.includes('bilbao')) return 'Bilbao';
  if (locationLower.includes('rotterdam')) return 'Rotterdam';
  if (locationLower.includes('the hague')) return 'The Hague';
  if (locationLower.includes('utrecht')) return 'Utrecht';
  if (locationLower.includes('eindhoven')) return 'Eindhoven';
  if (locationLower.includes('groningen')) return 'Groningen';
  if (locationLower.includes('salzburg')) return 'Salzburg';
  if (locationLower.includes('innsbruck')) return 'Innsbruck';
  if (locationLower.includes('linz')) return 'Linz';
  if (locationLower.includes('graz')) return 'Graz';
  if (locationLower.includes('klagenfurt')) return 'Klagenfurt';
