...
async function checkGYGImportStats() {
    ...
    try {
        ...
        // Get total count
        const totalCount = await dual_prisma_1.mainPrisma.importedGYGActivity.count();
        ...
        const providerStats = await dual_prisma_1.mainPrisma.importedGYGActivity.groupBy({
            by: ['providerName'],
            _count: { id: true },
            orderBy: { _count: { id: 'desc' } },
            take: 10
        ...
        const qualityStats = await dual_prisma_1.mainPrisma.importedGYGActivity.groupBy({
        ...
        const priceStats = await dual_prisma_1.mainPrisma.importedGYGActivity.aggregate({
        ...
        const ratingStats = await dual_prisma_1.mainPrisma.importedGYGActivity.aggregate({
        ...
        const reviewStats = await dual_prisma_1.mainPrisma.importedGYGActivity.aggregate({
        ...
        const madridCount = await dual_prisma_1.mainPrisma.importedGYGActivity.count({
            where: {
                location: {
                    contains: 'Madrid'
                }
        ...
        // Get recent imports
        const recentImports = await dual_prisma_1.mainPrisma.importedGYGActivity.findMany({
...
//# sourceMappingURL=check-gyg-import-stats.js.map