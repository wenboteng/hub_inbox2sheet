...
async function generateCompetitiveAnalysis() {
    ...
    try {
        ...
        const reportPath = (0, path_1.join)(process.cwd(), 'competitive-analysis-report.md');
...
async function analyzeCompetitiveLandscape(articles) {
...
async function generatePlatformComparisons(articles) {
...
function identifyMarketLeaders(platforms) {
...
function identifyNicheOpportunities(platforms) {
...
function identifyContentGaps(platforms) {
    const gaps = [];
...
function generateStrategicRecommendations(platforms) {
...
function createCompetitiveAnalysisReport(insights) {
...
//# sourceMappingURL=generate-competitive-analysis.js.map