...
exports.analyzeViennaActivities = analyzeViennaActivities;
...
${topRatedVienna.map((activity, index) => `${index + 1}. **${activity.activityName}** - ${activity.ratingNumeric}/5 (${activity.reviewCountNumeric || 0} reviews)`).join('\n')}

## 📈 Most Reviewed Vienna Activities
${mostReviewedVienna.map((activity, index) => `${index + 1}. **${activity.activityName}** - ${activity.reviewCountNumeric} reviews (${activity.ratingNumeric || 'N/A'}/5)`).join('\n')}
...
//# sourceMappingURL=analyze-vienna-activities.js.map