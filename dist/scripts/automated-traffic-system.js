...
exports.runAutomatedTrafficSystem = runAutomatedTrafficSystem;
const automated_seo_monitoring_1 = require("./automated-seo-monitoring");
const automated_content_optimization_1 = require("./automated-content-optimization");
const automated_social_media_scheduler_1 = require("./automated-social-media-scheduler");
...
async function runAutomatedTrafficSystem() {
    ...
    try {
        ...
        console.log('=========================\n');
        await (0, automated_seo_monitoring_1.automatedSEOMonitoring)();
        ...
        console.log('===============================\n');
        await (0, automated_content_optimization_1.automatedContentOptimization)();
        ...
        console.log('==================================\n');
        await (0, automated_social_media_scheduler_1.automatedSocialMediaScheduler)();
        ...
        (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), 'automated-traffic-report.json'), JSON.stringify(report, null, 2));
...
//# sourceMappingURL=automated-traffic-system.js.map