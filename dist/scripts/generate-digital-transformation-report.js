...
async function generateDigitalTransformationReport() {
    ...
    try {
        ...
        // Save to file
        const reportPath = (0, path_1.join)(process.cwd(), 'digital-transformation-report.md');
...
async function collectDigitalTransformationData() {
...
function createDigitalTransformationReport(data) {
...
function getPlatformOpportunities(platform) {
    const opportunities = {
...
function getPlatformTechAdoption(platform) {
    const adoption = {
...
function getCategoryFocus(category) {
...
//# sourceMappingURL=generate-digital-transformation-report.js.map