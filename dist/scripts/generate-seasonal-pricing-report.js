...
async function generateSeasonalPricingReport() {
    ...
    try {
        ...
        // Save report
        const reportPath = (0, path_1.join)(process.cwd(), 'seasonal-pricing-intelligence-report.md');
...
async function analyzeSeasonalPatterns(activities) {
...
async function analyzeLocationPricing(activities) {
...
async function analyzeProviderPricing(activities) {
...
async function generateSeasonalInsights(activities, seasonalData) {
...
function createSeasonalPricingReport(seasonalData, locationData, providerData, insights) {
...
//# sourceMappingURL=generate-seasonal-pricing-report.js.map