...
exports.setupGoogleAnalytics = setupGoogleAnalytics;
...
async function setupGoogleAnalytics() {
    ...
    (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), 'google-analytics-credentials-template.json'), JSON.stringify(credentialsTemplate, null, 2));
...
//# sourceMappingURL=setup-google-analytics.js.map