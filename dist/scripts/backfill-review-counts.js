...
exports.backfillReviewCounts = backfillReviewCounts;
...
async function backfillReviewCounts() {
    ...
    try {
        ...
        const importedActivities = await dual_prisma_1.mainPrisma.importedGYGActivity.findMany({
            where: {
                OR: [
        ...
        const rawData = await dual_prisma_1.gygPrisma.$queryRaw `
      SELECT 
        id,
        activity_name,
        review_count,
    ...
    `;
        ...
        function parseReviewCount(reviewCountText) {
...
//# sourceMappingURL=backfill-review-counts.js.map