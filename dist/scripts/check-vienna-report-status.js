...
exports.checkViennaReportStatus = checkViennaReportStatus;
...
async function checkViennaReportStatus() {
    ...
    try {
        ...
        const allReports = await dual_prisma_1.mainPrisma.report.findMany({
            where: { isPublic: true },
            select: {
                type: true,
                title: true,
...
//# sourceMappingURL=check-vienna-report-status.js.map