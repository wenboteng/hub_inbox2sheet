...
const enhanced_crawler_config_1 = require("./enhanced-crawler-config");
...
class ContentExpansionManager {
    ...
    async expandStackOverflow() {
        console.log('📚 Expanding StackOverflow collection...');
        const startTime = Date.now();
        const crawler = new enhanced_crawler_config_1.SafeCrawler(enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.stackoverflow);
        let newArticles = 0;
        let errors = 0;
        let skipped = 0;
        try {
            ...
            // Expand tag coverage
            const expandedTags = [
                ...enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.stackoverflow.tags,
            ...
            for (const tag of expandedTags.slice(0, 15)) { // Limit to 15 tags for safety
                ...
                try {
                    ...
                    const questionsPerTag = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.stackoverflow.maxQuestionsPerTag;
                    const answersPerQuestion = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.stackoverflow.maxAnswersPerQuestion;
    ...
    async expandAirbnbCommunity() {
        console.log('🏠 Expanding Airbnb Community collection...');
        const startTime = Date.now();
        const crawler = new enhanced_crawler_config_1.SafeCrawler(enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.airbnb);
        let newArticles = 0;
        let errors = 0;
        let skipped = 0;
        try {
            ...
            const enhancedThreadsPerCategory = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.airbnb.maxThreadsPerCategory;
            const currentRepliesPerThread = 100; // Current limit
            const enhancedRepliesPerThread = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.airbnb.maxRepliesPerThread;
            const categories = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.airbnb.categories;
    ...
    async expandReddit() {
        ...
        const startTime = Date.now();
        const crawler = new enhanced_crawler_config_1.SafeCrawler(enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.reddit);
        let newArticles = 0;
        let errors = 0;
        let skipped = 0;
        try {
            const subreddits = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.reddit.subreddits;
            for (const subreddit of subreddits) {
                ...
                try {
                    ...
                    const postsPerSubreddit = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.reddit.maxPostsPerSubreddit;
                    const commentsPerPost = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.reddit.maxCommentsPerPost;
    ...
    async expandTripAdvisor() {
        console.log('🗺️ Expanding TripAdvisor collection...');
        const startTime = Date.now();
        const crawler = new enhanced_crawler_config_1.SafeCrawler(enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.tripadvisor);
        let newArticles = 0;
        let errors = 0;
        let skipped = 0;
        try {
            const categories = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.tripadvisor.categories;
            for (const category of categories) {
                if (!crawler.shouldContinue()) {
                ...
                try {
                    ...
                    const enhancedThreadsPerCategory = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.tripadvisor.maxThreadsPerCategory;
                    const currentRepliesPerThread = 10; // Current limit
                    const enhancedRepliesPerThread = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.tripadvisor.maxRepliesPerThread;
                    const additionalThreads = enhancedThreadsPerCategory - currentThreadsPerCategory;
                    const additionalReplies = enhancedRepliesPerThread - currentRepliesPerThread;
    ...
    async expandGetYourGuide() {
        console.log('🎯 Expanding GetYourGuide collection...');
        const startTime = Date.now();
        const crawler = new enhanced_crawler_config_1.SafeCrawler(enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.getyourguide);
        let newArticles = 0;
        let errors = 0;
        let skipped = 0;
        try {
            const categories = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.getyourguide.categories;
            for (const category of categories) {
                if (!crawler.shouldContinue()) {
                ...
                try {
                    ...
                    const articlesPerCategory = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.getyourguide.maxArticlesPerCategory;
                    const pagesPerCategory = enhanced_crawler_config_1.ENHANCED_CRAWLER_CONFIG.platforms.getyourguide.maxPagesPerCategory;
...
main();
//# sourceMappingURL=safe-content-expansion.js.map