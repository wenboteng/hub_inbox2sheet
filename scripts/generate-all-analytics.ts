...
async function generateAllAnalytics(): Promise<void> {
  ...
  try {
    ...
    writeFileSync(summaryPath, executiveSummary, 'utf-8');
...
function createExecutiveSummary(): string {
