...
exports.generateSocialMediaContent = generateSocialMediaContent;
...
#AirbnbHost #AirbnbTips`,
    ...
    // Save to files
    (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), 'social-media-linkedin.txt'), linkedinContent);
    (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), 'social-media-twitter.txt'), twitterContent);
    (0, fs_1.writeFileSync)((0, path_1.join)(process.cwd(), 'social-media-facebook.txt'), facebookContent);
...
//# sourceMappingURL=social-media-launch.js.map