...
async function importMissingHighQualityViator() {
    console.log('📥 IMPORTING MISSING HIGH-QUALITY VIATOR ACTIVITIES...\n');
    try {
...
importMissingHighQualityViator().catch(console.error);
//# sourceMappingURL=import-missing-high-quality-viator.js.map